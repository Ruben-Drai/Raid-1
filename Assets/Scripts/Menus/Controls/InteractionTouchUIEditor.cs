...
{
    /// <summary>
    /// A custom inspector for <see cref="InteractionTouch"/> which provides a more convenient way for
    /// picking the binding which to rebind.
    /// </summary>
    [CustomEditor(typeof(InteractionTouch))]
    public class InteractionTouchUIEditor : UnityEditor.Editor
    {
